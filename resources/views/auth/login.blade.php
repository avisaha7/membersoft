    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card"  style="background:#C3CFDB;">
                <div class="card-header" style="background:#07A25A; color: #fff;"><h3>{{ __('Login') }}</h3></div>
                ...
                <div class="card-body">
                    <br>
                    <form class="m-4" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-link mb-4" href="{{'/register'}}" style="background:#025AA5;color: #ffff;">
