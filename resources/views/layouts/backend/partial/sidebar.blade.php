...
{{--   admin menubar         --}}
            ...
            <li class="{{Request::is('admin/dashboard') ? 'active' : ''}}">
                 ...
                 <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{url('admin/product_category/create')}}" class="{{Request::is('admin/sale*') ? 'active' : ''}}">New Category</a>
                            </li>
                ...
                <li class="{{Request::is('admin/pending/payment') ? 'active' : ''}}">
                    <a href="{{ route('admin.payment.pending') }}">
                        <i class="material-icons">library_books</i>
                        <span>Pending Payments</span>
                    </a>
                </li>
                <li class="{{Request::is('admin/approved/payment') ? 'active' : ''}}">
